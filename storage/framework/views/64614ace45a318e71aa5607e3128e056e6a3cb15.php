    ...
    <div style="width: 50%; margin:auto; padding: 4%; background-color:darkgrey;color:black; height:auto;">
        ...
        <form method="POST" action="/createuser" class="mt-10">
            ...
            <div class="form-group col-8">
                ...
                <input  class="form-control" type="text" name="name" id="name" placeholder="Enter Name" value="<?php echo e(old('name')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-8">
                ...
                <input  class="form-control" type="email" name="email" id="email" placeholder="Enter Email" value="<?php echo e(old('email')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-8">
                ...
                <input  class="form-control" type="text" name="phone" id="phone" placeholder="Enter Phone Number" value="<?php echo e(old('phone')); ?>" required>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\New folder\laravel-movie-booking\resources\views/admin/createuser.blade.php ENDPATH**/ ?>