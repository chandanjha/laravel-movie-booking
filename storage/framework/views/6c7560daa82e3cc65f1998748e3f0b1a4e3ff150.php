    ...
    <div style="width: 50%; margin:auto; padding: 4%; background-color:darkgrey;color:black; height:auto;">
        ...
        <form action="/newpassword" method="post">
            ...
            <div class="form-group col-8">
                ...
                <input class="form-control" type="text" name="otp" id="otp" placeholder="Enter the Otp" value="<?php echo e(old('otp')); ?>" required >
                <?php $__errorArgs = ['otp'];
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\cinembs\resources\views/sessions/otpverify.blade.php ENDPATH**/ ?>