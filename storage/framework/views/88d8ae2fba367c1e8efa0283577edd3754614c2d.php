    ...
    <div class="col-5" style="width: 50%; margin:auto; padding: 4%; background-color:darkgrey;color:black; height:auto;">
        ...
        <?php $i=0 ?>
            ...
            <tr style="background-color: #666;">
                ...
                <td>
                    <a class="btn btn-danger btn-sm" onClick="javascript: alert('Are you sure you want to delete cast'); " href="/deletecast/<?php echo e($cast->id); ?>"><i class="icon_close_alt2"></i></a>             
                </td>
            </tr>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\New folder\git\laravel-movie-booking\resources\views/admin/movie/addcast.blade.php ENDPATH**/ ?>