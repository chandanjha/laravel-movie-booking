        ...
        <div class="row" id="frontslide">
            ...
            <div class="slideshow-container">
                ...
                <?php if($movie->release_date <= $date): ?>
                    <?php $i = $i + 1 ?>
                    <div class="mySlides">
                        <a href="/viewmovie/<?php echo e($movie->id); ?>"><img src="/movieimage/<?php echo e($movie->movie_poster); ?>" alt="" style="width:100%"></a>
                        <div class="text"><a href="/viewmovie/<?php echo e($movie->id); ?>"><?php echo e(ucwords($movie->name)); ?></a></div>
                    </div>
                <?php endif; ?>
                <?php if($i>2): ?>
                    <?php break; ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\New folder\git\laravel-movie-booking\resources\views/home.blade.php ENDPATH**/ ?>