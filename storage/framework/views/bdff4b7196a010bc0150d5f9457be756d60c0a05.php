    ...
    <div style="width: 50%; margin:auto; padding: 4%; background-color:darkgrey;color:black; height:auto;">
        ...
        <form method="POST" action="/addtheater" class="mt-10">
            ...
            <div class="form-group col-8">
                ...
                <input class="form-control" type="text" name="name" id="name" placeholder="Enter Theater Name" value="<?php echo e(old('name')); ?>" required>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\cinembs\resources\views/admin/theater/addtheater.blade.php ENDPATH**/ ?>