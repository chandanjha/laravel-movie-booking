...
<?php endif; ?>
    <div style="width: 50%; margin:auto; padding: 4%; background-color:darkgrey;color:black; height:auto;">
        ...
        <form method="POST" action="/edituser/<?php echo e($user->id); ?>" class="mt-10">
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-8">
                ...
                <select class="form-control" name="user_role" id="user_role">
                    <option value="<?php echo e($user->user_role); ?>"><?php echo e($user->user_role); ?></option>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\cinembs\resources\views/admin/edituser.blade.php ENDPATH**/ ?>