...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-8">
                ...
                <input  class="form-control" type="password" name="password" id="password" placeholder="Enter the password" value="<?php echo e(old('otp')); ?>" required>
...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-8">
                ...
                <?php $__errorArgs = ['confirm_passowrd'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\New folder\laravel-movie-booking\resources\views/register/otpverify.blade.php ENDPATH**/ ?>