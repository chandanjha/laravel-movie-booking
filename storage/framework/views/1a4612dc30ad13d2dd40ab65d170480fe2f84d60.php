...
unset($__errorArgs, $__bag); ?>
            ...
            <div class="form-group col-8">
                ...
                <input class="form-control" type="text" name="address" placeholder="Enter Address" id="password" value="<?php echo e(old('address')); ?>"required>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\New folder\laravel-movie-booking\resources\views/admin/theater/addtheater.blade.php ENDPATH**/ ?>