    ...
    <div class="frontend">
        ...
        <div class="row">
            <div class="pull-right">
                <a class="btn btn-primary btn-lg" href="/showslots/<?php echo e($movie->id); ?>">Shows</a>
            </div>
        </div>
    </div>
 <?php if (isset($__componentOriginalc254754b9d5db91d5165876f9d051922ca0066f4)): ?>
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?><?php /**PATH G:\New folder\laravel-movie-booking\resources\views/viewmovie.blade.php ENDPATH**/ ?>